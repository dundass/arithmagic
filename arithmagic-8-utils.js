...
(function (tw) {
    ...
    var makeFullScreen = function (element) {
        ...
        if(typeof element === 'undefined')
            element = (document.getElementById('wrapper') || document.getElementById('container') || document.getElementById('animation_container') || document.documentElement);
    ...
    var listenForAnimationFramesReady = function (preloaderId) {
        ...
        var checkAnimationFrames = function () {
            if(typeof TwinklGame.templateCount !== "undefined") {
                if(TwinklGame.templatesLoaded === TwinklGame.templateCount) {
                    removePreloader();
                }
            } else {
    ...
    var track = function (eventName, eventData) {
        if(typeof window.Go !== 'undefined') {
            if(typeof window.Go.track !== 'undefined') {
                ...
                // $.post("/go/track/lesson", {event: eventName, resource_id: id, data: (typeof eventData === 'undefined' ? null : eventData)});
                Go.track(eventName, id, eventData);
            }
        } else {
    ...
    var siteInDev = function () {
        ...
        var domains = ['local.games.it', 'localhost', '127.0.0.1', '::1'];
